(function($){
	...
	jQuery(document).on('ready', function () {
        ...
        //validate visitor registration form 
        $( "#visitorsRegistration" ).validate();
		...
		// Count Time
        function makeTimer() {
            var endTime = new Date("march 25, 2021 17:00:00 PDT");
            ...
            $("#hours").html(hours + "<span>"+lang.hours+"</span>");
            $("#minutes").html(minutes + "<span>"+lang.minutes+"</span>");
            $("#seconds").html(seconds + "<span>"+lang.seconds+"</span>");
        }
